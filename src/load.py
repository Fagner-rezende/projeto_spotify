...
def get_latest_file():
    ...
    """
    # Lista se todos os arquivos que batem com o padrão
...
def load_data_to_sql():
    ...
    # O Pandas lê datas como string. Vamos converter para objeto de data/hora.
    ...
    try:
        ...
        # Para este projeto, vamos usar 'replace' para garantir que a estrutura esteja sempre certa. Para evitar duplicatas.
        # Em produção real, usaríamos 'append' com verificação de duplicatas. Para simplificar, usamos 'replace' aqui.
